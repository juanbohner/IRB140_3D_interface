...
# ------------------------- (el resto del código de prueba_4.py sin cambios) -------------------------
...
class ManipulabilityApp(QtWidgets.QWidget):
    ...
    def _play_step(self):
        ...
        # aplicar límites articulares antes de actualizar
...
# IMPORTANTE: en ManipulabilityApp.make_slider_callback y en _play_step
# añadimos un paso de clip_joints() antes de actualizar self.joints.

# Ejemplo en make_slider_callback:
# self.joints[idx] = angle
# self.joints = clip_joints(self.joints)

# Ejemplo en _play_step:
# self.joints = clip_joints(q)

# (El resto de la GUI, plotting, IK, trayectorias, etc. queda igual)
